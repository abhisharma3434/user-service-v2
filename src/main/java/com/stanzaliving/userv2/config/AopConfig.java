...
import com.stanzaliving.userv2.notification.SlackNotification;
...
public class AopConfig {
	...
	@Before(value = "execution(* com.stanzaliving.userv2.exception.ExceptionInterceptor.*(..)) && @annotation(com.stanzaliving.userv2.annotations.SendExceptionToSlack))")

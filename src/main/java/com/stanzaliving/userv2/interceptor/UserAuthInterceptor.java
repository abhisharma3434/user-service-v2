package com.stanzaliving.userv2.interceptor;


import com.stanzaliving.userv2.constants.SecurityConstants;
import com.stanzaliving.userv2.constants.StanzaConstants;
...
import com.stanzaliving.userv2.service.SessionServiceImpl;
import com.stanzaliving.userv2.utils.DateUtil;
import com.stanzaliving.userv2.utils.SecureCookieUtil;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
		...
		try {
			if (StringUtils.isNotBlank(token)) {
				...
				UserSessionEntity userSession = sessionServiceImpl.getUserSessionByToken(token);
...
//				break;
	...
	private void setUpdatedAtAndSave(UserSessionEntity userSession) {
		...
		sessionServiceImpl.updateUserSession(userSession);
	}
